...
{
    public class V_Leave_Early
    {
        public static int getLeaveEarlyNum(string _jN, string _yearAndMonth) {
            string procedureName = "get_Leave_Early_Num";
            ...
            OracleParameter param_vacation_hours = new OracleParameter("v_Leave_Early_Num", OracleDbType.Int32, ParameterDirection.Output);
