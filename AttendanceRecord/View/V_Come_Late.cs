...
{
    /// <summary>
    /// 迟到类。用来统计某指定月份总计迟到的次数。
    /// </summary>
    public class V_Come_Late 
    {
        #region 获得迟到的次数
        public static int getComeLateNum(string _jN, string _yearAndMonth) {
            string procedureName = "get_Come_Late_Num";
            ...
            OracleParameter param_vacation_hours = new OracleParameter("v_Come_Late_Num", OracleDbType.Int32, ParameterDirection.Output);
